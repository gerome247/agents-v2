...
const judgeSchema = z.object({
  score: z.number().min(0).max(10).describe("A score between 1 and 10 indicating the quality of the output. Where 10 is perfect and 1 is completely wrong."),
...
Evaluate if this response correctly uses the tool results to answer the task.`,
  ...
  return result.object.score / 10; // Normalize to 0-1
};
